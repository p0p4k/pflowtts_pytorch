...
class TextEncoder(nn.Module):
    ...
    def forward(
        ...
        speech_prompt_proj = self.prenet(speech_prompt_proj, speech_mask)
        x_split = self.prenet(x_emb, x_emb_mask)
        ...
        x_split_scale = self.film_scale(x_split) * x_split_mask 
        x_split_mean = self.film_mean(x_split) * x_split_mask
        
        x_split = (x_split_mean + x_emb * x_split_scale) * x_split_mask
